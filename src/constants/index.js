...
export const actionTypes = {
    ...
    GET_CURRENCIES_ABBREVIATIONS_START: 'GET_CURRENCIES_ABBREVIATIONS_START',
    GET_CURRENCIES_ABBREVIATIONS_SUCCESS: 'GET_CURRENCIES_ABBREVIATIONS_SUCCESS',
    GET_CURRENCIES_ABBREVIATIONS_FAILURE: 'GET_CURRENCIES_ABBREVIATIONS_FAILURE',

    GET_CURRENCIES_RETES_START: 'GET_CURRENCIES_RATES_START',
    GET_CURRENCIES_RETES_SUCCESS: 'GET_CURRENCIES_RATES_SUCCESS',
    GET_CURRENCIES_RETES_FAILURE: 'GET_CURRENCIES_RATES_FAILURE',
